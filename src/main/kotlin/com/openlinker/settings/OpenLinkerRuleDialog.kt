...
class OpenLinkerRuleDialog(initialRule: CustomUrlRule? = null) : DialogWrapper(true) {
    ...
    private fun buildEditorHeader(): JComponent {
        return JPanel(BorderLayout()).apply {
            ...
            add(variableButtonsPanel(), BorderLayout.EAST)
        }
    }
    ...
    private fun variableButtonsPanel(): JComponent {
        return JPanel(FlowLayout(FlowLayout.RIGHT, JBUI.scale(6), 0)).apply {
            ...
            SUPPORTED_VARIABLES.forEach { variable ->
                add(JButton(InsertVariableAction(variable)).apply {
    ...
    private inner class InsertVariableAction(private val variable: String) : AbstractAction(variable) {
